/**
 * Contenus de la page « Le groupe ».
 * Vocabulaire des participations : règle n°2 — ne pas reformuler.
 */
...
export const groupe = {
  ...
  histoire: {
    kicker: "Histoire",
    title: "Née du terrain, construite avec patience.",
    paragraphs: [
      "Le groupe s'est constitué autour d'une participation historique dans France Immeuble, maison de transaction dédiée aux vendeurs d'immeubles de rapport. De cette position d'actionnaire de référence est née une lecture précise du marché : ses usages, ses silences, ses angles morts.",
